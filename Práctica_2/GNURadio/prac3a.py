...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(len(h))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/com_2_A1_G9/com2_A1_G-9/Práctica_2/GNURadio/rana.jpg', True, 0, 0)
